...
# check_empty('C_calc/ads_slab')
# check_empty('CH_calc/ads_slab')
# check_empty('CH2_calc/ads_slab')
# check_empty('CH3_calc/ads_slab')
# check_empty('H2O_calc/ads_slab')
check_empty('pristine/ads_slab')
