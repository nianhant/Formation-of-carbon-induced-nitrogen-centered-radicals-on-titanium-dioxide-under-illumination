...
#### turn on D3
calc = SPARC(EXCHANGE_CORRELATION="HSE", SPIN_TYP=1,
             D3_FLAG= 1 , D3_RTHR= 9000.0,D3_CN_THR=1600.0,
             PRINT_FORCES=1, PRINT_ATOMS=1, PRINT_EIGEN=1, 
             TOL_FOCK=5e-05,
            EXX_DOWNSAMPLING= (2, 2, 1),
            # TOL_FOCK=3e-04,
              h = 0.1, KPOINT_GRID = [4, 4, 1],
             MAXIT_FOCK=20,  ACE_FLAG=1, TOL_SCF=1E-6,
