...
vib_eng_to_dict('slab')

def pickle_dump_vib():
    cur_dir = os.getcwd()
    file_name = 'HSE_'+str(cur_dir).split('/')[-1] + '.pkl'
    family_vib_eng_dict = dict()
    family_vib_eng_dict['ads_slab'] = vib_eng_to_dict('ads_slab')
    family_vib_eng_dict['slab'] = vib_eng_to_dict('slab')
